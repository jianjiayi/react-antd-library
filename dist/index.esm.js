...
import { Table, Row, Col, Form, Input, Select, Radio, Checkbox, Button, Switch, DatePicker, TimePicker, Space, message } from 'antd';
import _, { isArray, isPlainObject } from 'lodash';
import { DownOutlined, UpOutlined, CaretDownOutlined, ForkOutlined, ShareAltOutlined, CloseCircleOutlined } from '@ant-design/icons';
...
BaseTable = /*#__PURE__*/forwardRef(BaseTable);
...
function VMSFormItem(props) {
  ...
  return /*#__PURE__*/React.createElement(Form.Item, rest, children);
}

var VMSInput = /*#__PURE__*/forwardRef(function (props, ref) {
...
function entries(object) {
  ...
  // 对象
  if (isPlainObject(object)) return Object.entries(object).map(function (_ref) {
  ...
  if (isArray(object)) return object.map(function (v) {
...
function renderGroupComponent(iterable, Parent, Item, props) {
  ...
  if (iterable) {
    ...
    var child = isArray(iterable) ? iterable.map(forEach) : entries(iterable, forEach);
    return /*#__PURE__*/React.createElement(Parent, props, child);
  }
...
function VMSSelect(props) {
  ...
  try {
    ...
    return renderGroupComponent(map, Select, Select.Option, _objectSpread2({
      style: {
        maxWidth: 500
      },
...
function VMSButton(props) {
  ...
  return /*#__PURE__*/React.createElement(Button, rest, text || children);
}
...
function VMSPickerWithType(props) {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, pickerType === "DatePicker" && /*#__PURE__*/React.createElement(DatePicker, _extends({
    style: {
      minWidth: 300
    }
  }, rest)), pickerType === "TimePicker" && /*#__PURE__*/React.createElement(TimePicker, _extends({
    style: {
      minWidth: 300
    }
  }, rest)), pickerType === "RangePicker" && /*#__PURE__*/React.createElement(RangePicker, _extends({
    style: {
      minWidth: 300
    }
  }, rest)));
...
var FormOptions = {
  Select: function Select(options, props) {
    ...
    return /*#__PURE__*/React.createElement(VMSFormItem, options, /*#__PURE__*/React.createElement(VMSSelect, props));
  },
  Input: function Input(options, props) {
    return /*#__PURE__*/React.createElement(VMSFormItem, options, /*#__PURE__*/React.createElement(VMSInput, props));
  },
  TextArea: function TextArea(options, props) {
    return /*#__PURE__*/React.createElement(VMSFormItem, options, /*#__PURE__*/React.createElement(VMSTextArea, props));
  },
  Switch: function Switch(options, props) {
    return /*#__PURE__*/React.createElement(VMSFormItem, options, /*#__PURE__*/React.createElement(VMSSwitch, props));
  },
  Radio: function Radio(options, props) {
    return /*#__PURE__*/React.createElement(VMSFormItem, options, /*#__PURE__*/React.createElement(VMSRadio, props));
  },
  CheckBox: function CheckBox(options, props) {
    var map = props.map,
        rest = _objectWithoutProperties(props, ["map"]);

    return /*#__PURE__*/React.createElement(VMSFormItem, options, /*#__PURE__*/React.createElement(VMSCheckbox, props));
  },
  DatePicker: function DatePicker(options, props) {
    var map = props.map,
        rest = _objectWithoutProperties(props, ["map"]);

    return /*#__PURE__*/React.createElement(VMSFormItem, options, /*#__PURE__*/React.createElement(VMSPickerWithType, props));
  },
  DefaultChild: function DefaultChild(options, child) {
    return /*#__PURE__*/React.createElement(VMSFormItem, options, child);
  }
};
...
var RenderFormItem = function RenderFormItem(item, layout, params) {
  ...
  if (type && !_.isFunction(itemRender)) {
    ...
    return /*#__PURE__*/React.createElement(VMSCol, _extends({}, ColProps(layout, multiple), {
      key: name
    }), formItem);
  ...
  var Child = itemRender || /*#__PURE__*/React.createElement(VMSInput, _extends({}, rest, {
    allowClear: true,
...
var RenderButtonGroup = function RenderButtonGroup(props) {
  ...
  var rendeRexpandButton = function rendeRexpandButton(index, status) {
    if (index) return /*#__PURE__*/React.createElement(VMSButton, {
      type: "link",
      onClick: function onClick() {
        setExpand(!expand);
      }
    }, status ? "展开" : "收起", status ? /*#__PURE__*/React.createElement(DownOutlined, null) : /*#__PURE__*/React.createElement(UpOutlined, null));
  };

  return /*#__PURE__*/React.createElement(VMSCol, {
    style: {
      flex: 1
    }
  }, /*#__PURE__*/React.createElement(VMSFormItem, {
    wrapperCol: {
      xs: {
        span: 24
      },
  ...
  }, /*#__PURE__*/React.createElement(VMSButton, {
    type: "primary",
    onClick: function onClick() {
      submit();
    }
  }, finishText), /*#__PURE__*/React.createElement(VMSButton, {
    type: "dashed",
    onClick: function onClick() {
      return reset();
    }
  }, resetText), rendeRexpandButton(expandIndex, expand), _.isFunction(buttonChildren) && buttonChildren())));
};
...
function BaseForm(props) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: classNames(className, styles$2.container)
  }, /*#__PURE__*/React.createElement(Form, _extends({
    form: form,
    ref: pRef
  }, formLayout(layout)), /*#__PURE__*/React.createElement(VMSRow, {
    gutter: 24
  }, render(expandIndex, expand, dataSource, formValues), children, !pForm && /*#__PURE__*/React.createElement(RenderButtonGroup, buttonProps))));
}
...
var FormListTree = function FormListTree(props) {
  ...
  var RenderButtonGroup = function RenderButtonGroup(props) {
    var field = props.field,
        ...
        remove = props.remove,
        children = props.children;
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(VMSButton, {
      type: "link",
      icon: /*#__PURE__*/React.createElement(ShareAltOutlined, null),
      onClick: function onClick() {
        return add();
      }
    }), children, /*#__PURE__*/React.createElement(VMSButton, {
      type: "link",
  ...
  var renderList = function renderList(field, index, add, remove) {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      type: "link",
      icon: /*#__PURE__*/React.createElement(CaretDownOutlined, null),
      onClick: function onClick() {
        return onCollapse(index);
      }
    }), /*#__PURE__*/React.createElement(VMSFormItem, _extends({}, field, {
    ...
    }), /*#__PURE__*/React.createElement(VMSSelect, {
      map: fieldOptionsMap,
      style: {
        width: 150
      },
      ...
      return /*#__PURE__*/React.createElement(VMSFormItem, _extends({}, field, {
        ...
        shouldUpdate: true
      }), /*#__PURE__*/React.createElement(VMSInput, {
        placeholder: "\u8BF7\u8F93\u5165..."
      }));
    }), /*#__PURE__*/React.createElement(RenderButtonGroup, buttonProps, /*#__PURE__*/React.createElement(VMSButton, {
      type: "link",
      icon: /*#__PURE__*/React.createElement(ForkOutlined, null),
      onClick: function onClick() {
      ...
      var add = _ref2.add,
          remove = _ref2.remove;
      return /*#__PURE__*/React.createElement(React.Fragment, null, !_.isEmpty(fields) && fields.map(function (field, key) {
  ...
  return /*#__PURE__*/React.createElement(Form.List, {
    ...
    var add = _ref3.add,
        remove = _ref3.remove;
    return /*#__PURE__*/React.createElement(React.Fragment, null, !_.isEmpty(fields) && fields.map(function (field, index) {
      return renderList(field, "".concat(index), add, remove);
    }));
  });
};

export { BaseForm, FormListTree as BaseFormListTree, BaseTable$1 as BaseTable, index as Foo };
